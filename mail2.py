...
def speak():     # this function is associated with the speak button
    mixer.init()
    mixer.music.load('Project_Py\\Tkinter\\image\\music.mp3')
    mixer.music.play()
...
logo=PhotoImage(file='D:\\python program\\Project_Py\\Tkinter\\image\\mail1.png')
...
logo2=PhotoImage(file='D:\\python program\\Project_Py\\Tkinter\\image\\set3 (1).png')
...
logo3=PhotoImage(file='D:\\python program\\Project_Py\\Tkinter\\image\\browse (2).png')
...
logo_mic=PhotoImage(file='D:\\python program\\Project_Py\\Tkinter\\image\\mic (2).png')
...
logo_attach=PhotoImage(file='D:\\python program\\Project_Py\\Tkinter\\image\\attachment (2).png')
...
logo_send=PhotoImage(file='D:\\python program\\Project_Py\\Tkinter\\image\\send.png')
...
logo_erase=PhotoImage(file='D:\\python program\\Project_Py\\Tkinter\\image\\erase.png')
...
logo_exit=PhotoImage(file='D:\\python program\\Project_Py\\Tkinter\\image\\exit.png')
